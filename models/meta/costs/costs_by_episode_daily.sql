...
select coalesce(
    ...
    , (coalesce(priced_episodes.cc_cost,0) +
        coalesce(priced_episodes.nc_cost,0) +
        coalesce(priced_episodes.np_cost,0) +
        coalesce(priced_videos.gp_psy_cost,0) +
        coalesce(priced_videos.gp_other_cost,0)) as total_cost
